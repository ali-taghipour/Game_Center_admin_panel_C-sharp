<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sendContent.aspx.cs" Inherits="sendContent" %>
                ...
                <div class="col-md-9 personal-info">
                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" type="text" placeholder="زولا" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">شرکت سازنده :</label>
                            <div class="col-md-8">
                                <input class="form-control" type="text" placeholder="رضوان استار" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">سال ساخت :</label>
                            <div class="col-md-8">
                                <input class="form-control" type="text" placeholder="2019" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label">بارگذاری عکس بازی :</label>
                            <div class="col-lg-8">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label">بارگذاری ویدیو بازی یا رکورد :</label>
                            <div class="col-lg-8">
