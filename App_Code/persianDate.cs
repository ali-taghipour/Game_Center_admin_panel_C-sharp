...
/// <summary>
/// Summary description for persiondate
/// </summary>
...
namespace persianDateTime
{
        ...
        IEquatable<PersianDateTime>, IEquatable<DateTime>
    {
        ...
        /// </summary>
        public MD.PersianDateTime.PersianDayOfWeek PersianDayOfWeek
        {
            get
            {
                DayOfWeek dayOfWeek = PersianCalendar.GetDayOfWeek(_dateTime);
                MD.PersianDateTime.PersianDayOfWeek persianDayOfWeek;
                switch (dayOfWeek)
                {
                    case DayOfWeek.Sunday:
                        persianDayOfWeek = MD.PersianDateTime.PersianDayOfWeek.Sunday;
                        break;
                    case DayOfWeek.Monday:
                        persianDayOfWeek = MD.PersianDateTime.PersianDayOfWeek.Monday;
                        break;
                    case DayOfWeek.Tuesday:
                        persianDayOfWeek = MD.PersianDateTime.PersianDayOfWeek.Tuesday;
                        break;
                    case DayOfWeek.Wednesday:
                        persianDayOfWeek = MD.PersianDateTime.PersianDayOfWeek.Wednesday;
                        break;
                    case DayOfWeek.Thursday:
                        persianDayOfWeek = MD.PersianDateTime.PersianDayOfWeek.Thursday;
                        break;
                    case DayOfWeek.Friday:
                        persianDayOfWeek = MD.PersianDateTime.PersianDayOfWeek.Friday;
                        break;
                    case DayOfWeek.Saturday:
                        persianDayOfWeek = MD.PersianDateTime.PersianDayOfWeek.Saturday;
                        break;
                    default:
