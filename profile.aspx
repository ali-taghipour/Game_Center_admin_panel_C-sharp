            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="text-center">
                        ...
                        <label for="pers_pic"><h6>آپلود عکس</h6></label>
                    </div>
                </div>
                ...
                <div class="col-md-9 personal-info">
                    ...
                    <form class="form-horizontal" role="form">
                        <div class="form-group">
                            <label class="col-lg-3 control-label">اسم :</label>
                            <div class="col-lg-8">
                                <input class="form-control" type="text" placeholder="علی" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label">نام خانوادگی :</label>
                            <div class="col-lg-8">
                                <input class="form-control" type="text" placeholder="تقی پور" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">نام کاربری :</label>
                            <div class="col-md-8">
                                <input class="form-control" type="text" placeholder="ali78" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label">ایمیل :</label>
                            <div class="col-lg-8">
                                <input class="form-control" type="text" placeholder="ali@gmail.com" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">رمز ورود :</label>
                            <div class="col-md-8">
                                <input class="form-control" type="password" placeholder="aaAA##55" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">تایید رمز ورود :</label>
                            <div class="col-md-8">
                                <input class="form-control" type="password" placeholder="aaAA##55" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label">سن :</label>
                            <div class="col-lg-8">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label">سبک بازی مورد علاقه :</label>
                            <div class="col-lg-8">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label">استان :</label>
                            <div class="col-lg-8">
                                <input class="form-control" type="text" placeholder="مازندران" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label">شهر :</label>
                            <div class="col-lg-8">
                                <input class="form-control" type="text" placeholder="ساری" />
                            </div>
                        </div>
                        <div class="form-group">
